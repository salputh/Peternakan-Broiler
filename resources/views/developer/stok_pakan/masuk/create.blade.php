     ...
     <div class="max-w-3xl mx-auto bg-white shadow-sm rounded-lg border border-gray-200">
          <div class="px-6 py-4 border-b border-gray-200">
               <div class="flex items-center space-x-3">
                    ...
                    <div>
                         <h2 class="text-lg font-medium text-gray-900">Tambah Stok Pakan</h2>
                         <p class="mt-1 text-sm text-gray-500">Masukkan informasi stok pakan yang akan ditambahkan ke sistem</p>
                    </div>

               </div>
          </div>

          <form method="POST" action="{{ route('developer.stok_pakan.masuk.store', [
               ...
               <div x-data="{ open: false, selected: null }">
                    ...
                    <div class="relative mt-2">
                         <button type="button"
                              ...
                              <span class="col-start-1 row-start-1 flex items-center gap-3 pr-6">
                                   ...
                                   <span class="block truncate" x-text="selected ? selected.kode : '-- Pilih Jenis Pakan --'"></span>
                              </span>
                         ...
                         <input type="hidden"
                              name="pakan_jenis_id"
                              x-bind:value="selected ? selected.id : ''"
                              required
                              x-ref="pakanInput"
                         ...
                         <ul x-show="open"
                              ...
                              <li class="relative cursor-default select-none py-2 pl-3 pr-9 text-gray-900 hover:bg-blue-50"
                                   ...
                                   <div class="flex items-center">
                                        ...
                                        <span class="ml-3 block truncate" :class="{ 'font-semibold': selected && selected.id === '{{ $pj->id }}' }">
                                             {{ $pj->kode }}
                                        </span>
                                   </div>

                                   <span x-show="selected && selected.id === '{{ $pj->id }}'"
                    ...
                    <p class="mt-2 text-sm text-gray-500">Pilih jenis pakan yang akan ditambahkan stoknya</p>
               ...
               <div>
                    ...
                    <div class="mt-2 relative rounded-md shadow-sm">
                         <input type="number" name="jumlah_masuk" id="jumlah_masuk" autocomplete="given-name" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
