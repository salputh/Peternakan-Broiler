...
<div class="p-8 max-w-7xl mx-auto">
     <h1 class="text-2xl font-bold text-gray-800">Stok Obat</h1>
     <nav class="mt-2 text-sm text-gray-500" aria-label="Breadcrumb">
          <ol class="flex items-center space-x-2">
               ...
               <li class="text-blue-600">Stok Obat</li>
          </ol>
     </nav>
</div>
...
<div x-data="{ tab: '{{ $initialTab }}' }" class="px-8 max-w-7xl mx-auto">
     ...
     <div class="bg-white rounded-xl shadow-md overflow-hidden">
          <div x-show="tab === 'ringkasan'" x-cloak>
               @include('developer.stok_obat.ringkasan')
          </div>

          <div x-show="tab === 'masuk'" x-cloak>
               @include('developer.stok_obat.masuk.index')
          </div>

          <div x-show="tab === 'keluar'" x-cloak>
               @include('developer.stok_obat.keluar.index')
          </div>
     </div>
</div>
