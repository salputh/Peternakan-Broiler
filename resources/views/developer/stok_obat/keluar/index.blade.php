     ...
     <div x-data="{ currentView: 'table' }">
          <div class="flex items-center justify-between p-6">
               <div class="flex items-center">
                    ...
                    <h2 class="ml-2 text-xl font-semibold text-gray-800">Stok Obat Harian</h2>
               </div>
          </div>
               ...
               <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                         ...
                         <tr class="hover:bg-gray-50 transition">
                              ...
                              <td class="px-6 py-4 text-center whitespace-nowrap text-sm text-gray-900">{{ $item->obatJenis->nama ?? '-' }}</td>
                         ...
                         @empty
                         <tr>
                              <td colspan="6" class="px-6 py-4 text-center text-gray-400">Tidak ada data stok pakan keluar.</td>
                         </tr>
                         @endforelse
                    </tbody>
               </table>
