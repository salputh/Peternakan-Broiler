<div class="max-w-7xl mx-auto">
     ...
     <div class="p-6 flex justify-between items-center">
          <div class="flex items-center">
               ...
               <h2 class="ml-2 text-xl font-semibold text-gray-800">Daftar Stok Obat</h2>
          </div>
     </div>
          ...
          <table class="min-w-full divide-y divide-gray-200">
               <thead class="bg-gray-50">
                    <tr>
                         ...
                         <th class="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Nama Obat</th>
                         <th class="px-6 py-3 text-center text-xs font-bold text-gray-700 uppercase tracking-wider">Kategori</th>
               ...
               <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($ringkasan->where('jumlah_tersedia', '>', 0) as $stok)
                    <tr class="hover:bg-gray-50 transition-colors">
                         ...
                         <td class="px-6 py-4 text-center whitespace-nowrap text-sm font-bold text-gray-700">{{ $stok->kategori }}</td>
                         <td class="px-6 py-4 text-center whitespace-nowrap text-sm font-bold text-gray-700">{{ $stok->satuan ?? 'PCS' }}</td>
                         <td class="px-6 py-4 text-center whitespace-nowrap text-sm text-gray-900">{{ $stok->jumlah_masuk }}</td>
                         <td class="px-6 py-4 text-center whitespace-nowrap text-sm text-gray-900">{{ $stok->jumlah_terpakai }}</td>
                         <td class="px-6 py-4 text-center whitespace-nowrap text-sm text-gray-900">{{ $stok->jumlah_tersedia }}</td>
                    </tr>
                    @empty
                    <tr>
                         <td colspan="7" class="px-6 py-4 text-center text-gray-500">
                              <div class="flex flex-col items-center py-6">
                                   ...
                                   <p class="text-lg">Belum ada data stok obat</p>
                              </div>
                         </td>
                    </tr>
                    @endforelse
