      ...
      <div class="flex min-h-screen items-center justify-center p-4">
            <div class="w-full max-w-lg overflow-hidden rounded-lg bg-white p-14 shadow-lg">
                  <div class="text-center space-y-4">
                        ...
                        <h2 class="text-3xl font-extrabold text-gray-900 tracking-tight">Selamat Datang Dev</h2>
                  ...
                  <!-- Login Form -->
                  <form class="mt-8 space-y-8" method="post" action="{{ route('dev.login') }}">
                        @csrf
                        <div class="space-y-7">
                              <div>
                                    <label for="email" class="block text-sm font-medium text-gray-700">Email Developer</label>
